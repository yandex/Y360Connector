...
{
    class TaskEntityMapper : IEntityMapper<ITaskItemWrapper, IICalendar, int>
    {
        ...
        public TaskEntityMapper(string localTimeZoneId, TaskMappingConfiguration configuration)
        {
        ...
        public Task<IICalendar> Map1To2(ITaskItemWrapper source, IICalendar existingTargetCalender, IEntitySynchronizationLogger logger, int context)
        {
            ...
            CalDavSynchronizer.DDayICalWorkaround.CalendarDataPreprocessor.FixTimeZoneDSTRRules(_localTimeZoneInfo, localIcalTimeZone);
